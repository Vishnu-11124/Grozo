...
const Products = () => {
  ...
  }, [category, organic, sort, minPrice, maxPrice, page, search]);
          ...
          <main className="flex-1 min-w-0">
            ...
            <div className="mb-5 flex items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-[#9abfaa]">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative flex items-center rounded-xl border border-[#d8e8de] bg-white px-3 py-2 focus-within:border-[#2d6a4a]">
                  ...
                  <ChevronDown
                    size={14}
                    className="pointer-events-none absolute right-3 text-[#9abfaa]"
                  />
                </div>
              </div>
            </div>
            ...
            {products.length === 0 ? (
              <div className="flex flex-col items-center justify-center gap-4 rounded-2xl border border-[#e4ede8] bg-white py-20 text-center">
                <p className="text-base font-semibold text-[#3a5a46]">
                  No products found
                </p>
                <button
                  onClick={clearFilter}
