      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 md:px-6">
        ...
        <div>
          <div className="hidden md:flex gap-6">
            <Link
              to="/"
              className="text-sm font-medium text-[#3a5a46] hover:text-[#1e3a2f] transition"
            >
              Home
            </Link>
            <Link
          ...
          <div className="relative">
            {user ? (
              ...
              <div className="flex items-center gap-2">
                <Link
                  to="/login"
                  className="flex items-center gap-1.5 rounded-xl bg-[#1e3a2f] px-4 py-2 text-sm font-medium text-white hover:bg-[#2d6a4a] transition"
                >
                  <UserIcon size={14} />
                  Sign In
                </Link>
                ...
                <div className="px-4 pb-3">
                  ...
                  >
                    {!user && (
                      <Link
                        to="/login"
                        className="flex items-center gap-2 rounded-lg px-2 py-2 text-sm text-[#3a5a46] hover:bg-[#f7f5f0] transition"
                      >
                        <UserIcon size={15} className="text-[#9abfaa]" />
                        Sign In
                      </Link>
                    )}
                    {user && (
                      <div className="flex flex-col gap-0.5">
                        <Link
                          ...
                          className="flex items-center gap-2 rounded-lg px-2 py-2 text-sm text-[#3a5a46] hover:bg-[#f7f5f0] transition"
                        >
                          <PackageIcon size={15} className="text-[#9abfaa]" />
                          My Orders
                        </Link>
                        <Link
                          to="/addresses"
                          className="flex items-center gap-2 rounded-lg px-2 py-2 text-sm text-[#3a5a46] hover:bg-[#f7f5f0] transition"
                        >
                          <MapPinIcon size={15} className="text-[#9abfaa]" />
                          Addresses
                        </Link>
                      </div>
                    )}
                    <Link
                      ...
                      className="flex items-center gap-2 rounded-lg px-2 py-2 text-sm text-[#3a5a46] hover:bg-[#f7f5f0] transition"
                    >
                      <ArrowUpRightIcon size={15} className="text-[#9abfaa]" />
                      Products
                    </Link>
                    <Link
                      to="/deals"
                    ...
                    {user?.isAdmin && (
                      <Link
                        ...
                        className="flex items-center gap-2 rounded-lg px-2 py-2 text-sm text-[#3a5a46] hover:bg-[#f7f5f0] transition"
                      >
                        <ShieldIcon size={15} className="text-[#9abfaa]" />
                        Admin Panel
                      </Link>
                    )}
                    {user && (
